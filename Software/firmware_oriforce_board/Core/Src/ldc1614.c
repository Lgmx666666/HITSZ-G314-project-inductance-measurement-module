...
uint8_t ldc1614_init(void){
  ...
  ldc1614_writeWord(LDC13xx16xx_CMD_DRIVE_CURRENT_CH0, 0x7100);
  ldc1614_writeWord(LDC13xx16xx_CMD_DRIVE_CURRENT_CH1, 0x7100);
  ldc1614_writeWord(LDC13xx16xx_CMD_DRIVE_CURRENT_CH2, 0x7100);
  // mux_config
  ldc1614_writeWord(LDC13xx16xx_CMD_MUX_CONFIG, 0xA20D);
  // config
  ldc1614_writeWord(LDC13xx16xx_CMD_CONFIG, 0x1621);
}
